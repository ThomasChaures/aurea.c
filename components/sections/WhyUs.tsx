    ...
    <>
      ...
      <SectionHelper className="relative mt-80 mb-20 ">
        ...
        <div className="bg-[#21251A] mx-auto w-full items-center flex flex-col justify-between  h-[484px] p-10 rounded-[64px] shadow-[0px_-4px_10.2px_0px_#00000040] gap-y-0 relative overflow-hidden z-10">
           <InnerBar inner className="w-[1032px] z-2   h-[52px]">
            <div className="animate-marquee whitespace-nowrap font-sans font-light inline-block">
                {/* Items originales */}
                {items.map((item, i) => (
          ...
          <p className="font-sans text-[25px] z-2 font-light leading-9  text-white text-center">
          ...
          <div>
            <ul className="flex z-2 items-center justify-center  text-white  gap-x-6">
              <li className="rounded-3xl z-2  p-6 bg-white/15 border border-[#FFFFFF1F] shadow-xl shadow-black/30 backdrop-blur-[48px]">
                <span className="font-light text-xl">87%</span>
                <p className="opacity-50 mt-3">of members report</p>
                <p>steadier appetite control</p>
              </li>
              <li className="rounded-3xl z-2   bg-white/15 p-6 border border-[#FFFFFF1F] shadow-xl shadow-black/30 backdrop-blur-[48px]">
